...
public static class Braille {
    public static (ImageSize Size, string Data) ImageToBraille(Image<Rgba32> image, int maxCellWidth, int maxCellHeight) {
        ImageSize imageSize = SizeHelperDev.GetBrailleTargetSize(image, maxCellWidth, maxCellHeight);
        Image<Rgba32> resizedImage = ResizerDev.ResizeForBraille(image, imageSize);
